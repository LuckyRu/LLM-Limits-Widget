...
Проект перешёл от исследования к поэтапной реализации. Архитектура v2 зафиксирована, M1 (чистый Domain core и boundary tests) реализован рядом с текущим рабочим WPF-прототипом. Подключение нового core к provider pipelines и WPF выполняется отдельными вертикальными срезами.
