...
- [Architecture v2: M17 operability and release delivery](technical/architecture-v2-m17-operability-release-2026-08-15.md) — Claude hybrid scheduling, diagnostics, autostart, CI, portable release и installer.
