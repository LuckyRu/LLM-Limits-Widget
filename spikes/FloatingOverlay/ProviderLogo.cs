...
public sealed class ProviderLogo : FrameworkElement
{
    public static readonly DependencyProperty ProviderProperty = DependencyProperty.Register(
        nameof(Provider), typeof(ProviderLogoKind), typeof(ProviderLogo),
        new FrameworkPropertyMetadata(ProviderLogoKind.OpenAi, FrameworkPropertyMetadataOptions.AffectsRender));

    public static readonly DependencyProperty ForegroundProperty = DependencyProperty.Register(
        nameof(Foreground), typeof(WpfBrush), typeof(ProviderLogo),
        new FrameworkPropertyMetadata(System.Windows.Media.Brushes.Black, FrameworkPropertyMetadataOptions.AffectsRender));

    public ProviderLogoKind Provider
    {
        get => (ProviderLogoKind)GetValue(ProviderProperty);
